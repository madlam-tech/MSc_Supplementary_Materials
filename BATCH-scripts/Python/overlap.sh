...
if [ $jobid -eq 1 ] ; then
  bat="001"
  job="001/000001"
  opt="-h 1-4785 -r 1-4785 --hashdatalen 80011788"
fi

if [ $jobid -eq 2 ] ; then
  bat="001"
  job="001/000002"
  opt="-h 4786-7626 -r 1-7626 --hashdatalen 46663980"
fi
...
if [ ! -e ../0-mercounts/BC10.ms22.dump ] ; then
  mkdir -p ../0-mercounts
  cd ../0-mercounts
  cd -
fi
