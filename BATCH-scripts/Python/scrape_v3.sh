...
for log_file in "${directory}"*_log.txt; do
    ...
    echo -e "$base_name\t$initial_orfs\t$initial_pseudogenes\t$num_contigs\t$initial_orfs_joined\t$pseudogenes_total\t$pseudogenes_too_short\t$pseudogenes_too_long\t$pseudogenes_fragmented\t$pseudogenes_no_predicted_orf\t0\t0\t0\t0\t0\t0\t$intact_genes" >> "$output_table"
done
