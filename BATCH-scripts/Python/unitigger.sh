...
if [ -e BC10.ctgStore/seqDB.v001.tig ]; then
  exists=true
else
  exists=false
fi
...
if [ -e ./BC10.ctgStore ] ; then
  mv ./BC10.ctgStore ../BC10.ctgStore
fi
...
#
if [ -e ../BC10.ctgStore -a \
   ! -e ../BC10.ctgStore/seqDB.v001.sizes.txt ] ; then
  $bin/tgStoreDump \
    -S ../../BC10.seqStore \
    -T ../BC10.ctgStore 1 \
    -sizes -s 2600000 \
   > ../BC10.ctgStore/seqDB.v001.sizes.txt
fi
