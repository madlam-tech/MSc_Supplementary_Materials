...
#SBATCH -e 21-prokka_multi_v2%j.log
mkdir -p prokka
...
prokka --compliant --rfam --kingdom Bacteria --usegenus --genus Pseudomonas  ${filename} \
	--dbdir /scale_wlg_persistent/filesets/opt_nesi/CS400_centos7_bdw/prokka/1.14.5-GCC-9.2.0/db \
	--outdir ./prokka_v2/prokka.${BASENAME}	--prefix ${BASENAME} \
	--addgenes \
	--addmrna \
	--coverage 70 
