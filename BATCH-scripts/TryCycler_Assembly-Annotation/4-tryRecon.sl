...
#trycycler reconcile --reads ./../filtered/*fq --cluster_dir ./clusters/cluster_007
#trycycler reconcile --reads ./../filtered/*fq --cluster_dir ./clusters/cluster_008
#trycycler reconcile --reads ./../filtered/*fq --cluster_dir ./clusters/cluster_009
...
#trycycler reconcile --reads ./../filtered/*fq --cluster_dir ./clusters/cluster_012
