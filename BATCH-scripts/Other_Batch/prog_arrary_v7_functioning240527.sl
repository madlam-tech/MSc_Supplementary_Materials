...
#SBATCH --time          0:35:00
#SBATCH --array         1-91  #  14 sequences = 14*13/2
#SBATCH --mem           8GB
...
output_dir="/pro_mauve_24-06-07"

# Create the output directory if it doesn't exist
mkdir -p "$output_dir"

# Get the list of sequence files
files=("$directory"/*.fasta)
...
sequence_name1=$(basename "$sequence_file1" .fasta)
sequence_name2=$(basename "$sequence_file2" .fasta)
