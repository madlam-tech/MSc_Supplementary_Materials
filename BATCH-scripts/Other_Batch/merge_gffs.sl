...
# Define directories for Prokka, Pseudofinder, and Barrnap rRNA data
...
output_dir <- "/nesi/nobackup/massey03345/fnas_complete_set/merged_data/"
dir.create(output_dir, showWarnings = FALSE)
write_tsv(merged_data, file.path(output_dir, "merged_prokka_pseudofinder_barrnap_data.tsv"))
