...
input_dir="/nesi/nobackup/massey03345/fnas_4_annotation/fnas_4_prokka_header_fixed"
...
for fna_file in "$input_dir"/*.fna; do
    ...
    # Extract the directory name based on the filename pattern
    dirname=$(dirname "$fna_file")
