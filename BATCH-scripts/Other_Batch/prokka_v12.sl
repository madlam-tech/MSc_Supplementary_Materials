...
#SBATCH -e 12-prokka_v12%j.err
#SBATCH -o 12-prokka_v12%j.log

module purge
module load prokka/1.14.5-GCC-9.2.0

# Directory containing the fna files
input_dir="/nesi/nobackup/massey03345/fnas_4_annotation/staph/all_fnas"

# Create directory for Prokka output on NeSI
output_dir="/nesi/nobackup/massey03345/fnas_4_annotation/staph/prokka_output"
mkdir -p "$output_dir"
